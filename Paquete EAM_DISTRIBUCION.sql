create or replace package EAM_DISTRIBUCION is
  --********************
...
end EAM_DISTRIBUCION;
/
create or replace package body EAM_DISTRIBUCION is
  ...
  begin
    ...
    for cir in (select circuito from eam_circuitos where grupo = pGrupo) loop
      ...
      exception
        ...
        when eam_energia.circuito_sin_interruptor then
          update eam_circuitos
        ...
        when eam_energia.trace_con_varios_interruptores then
          update eam_circuitos
  ...
  begin
    ...
    vCorte := EAM_ENERGIA.EAM_TRACE_CIR(pcircuito);
    ...
    EAM_ENERGIA.EAM_MANEJO_ACTIVO(pcircuito);
    EAM_ENERGIA.EAM_MANEJO_NOVEDADES(pcircuito);
    EAM_ENERGIA.EAM_MANEJO_RETIRADOS(pcircuito);
  ...
  begin
    ...
    EAM_ENERGIA.EAM_MANEJO_RETIRADOS('PARRILLA');
    EAM_ENERGIA.EAM_MANEJO_NOVEDADES('PARRILLA');
  ...
  begin
    ...
    if pLimpiarTablas = 1 then
      EAM_ENERGIA.EAM_LIMPIAR_TABLAS;
    end if;
  
    EAM_ENERGIA.EAM_RESPALDAR_TABLAS;
  ...
  begin
    ...
    EAM_ENERGIA.EAM_MANEJO_ACTIVO('ESTRUCTURA');
    EAM_ENERGIA.EAM_MANEJO_RETIRADOS('ESTRUCTURA');
    EAM_ENERGIA.EAM_MANEJO_NOVEDADES('ESTRUCTURA');
